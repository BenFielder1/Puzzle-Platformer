...
class Football extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image("player", "/assets/player/stand.png")
        this.load.image("player1r", "/assets/player/walk1r.png")
        this.load.image("player2r", "/assets/player/walk2r.png")

        this.load.image("grass", "/assets/ground/grass.png")
        this.load.image("grass-wall", "/assets/ground/grass-wall.png")

        this.load.image("football", "/assets/football/football.png")
        
        this.load.image("goal", "/assets/football/goal.png")
